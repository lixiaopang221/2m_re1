...
from utils.dataset_KidT import BatchGenerator3D_random_sampling, load_dataset
...
class Params:
    ...
    model_path = './model/gan/gan_22_KidT/' + '_'.join(modal_dict.keys())
    data_dir = DataPath.preprocessed_training_data_folder
    train_idxs = range(285)
    out_dir = './gan_train_KidT'
    model_idx = 5
    log_file_path = './logs/GAN_train_KidT.txt'
