...
class Params:
    ...
    print_freq     = 20
    save_freq      = 200
    modal_trans    = '23to23' #---01to23, 01to01, 23to23
    modal_dict     = {'t1':0,'t1ce':1,'t2':2,'flair':3}  #---{'t1':0,'t1ce':1,'t2':2,'flair':3}
    model_path     = './model/gan/gan_22/' + modal_trans
...
def train():
    ...
    modal_x = [int(x) for x in Params.modal_trans.split('to')[0]]
    modal_y = [int(x) for x in Params.modal_trans.split('to')[1]]
