...
class Params:
    ...
    print_freq    = 20
    save_freq     = 200
    model_path    = './model/gan_22_of_17'
    txt_postfix   = 'gan_22_of_17' + '_' + '_'.join(modal_dict.keys())
    data_dir      = DataPath.preprocessed_training_data_folder
    data_argument = False

    #---Testing setting
    saved_model    = './model/gan_22_of_17/model_4'
    test_save_dir  = './results/gan_22_of_17'
